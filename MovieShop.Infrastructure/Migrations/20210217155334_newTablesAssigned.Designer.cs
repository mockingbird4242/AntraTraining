...
namespace MovieShop.Infrastructure.Migrations
{
    ...
    [Migration("20210217155334_newTablesAssigned")]
    partial class newTablesAssigned
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieShop.Core.Entities.Cast", b =>
                {
                    b.HasOne("MovieShop.Core.Entities.MovieCast", "MovieCast")
                        .WithMany("Casts")
                        .HasForeignKey("MovieCastMovieId");
            ...
            modelBuilder.Entity("MovieShop.Core.Entities.Favorite", b =>
                {
                    b.HasOne("MovieShop.Core.Entities.Movie", "Movie")
                        .WithOne("Favorite")
                        .HasForeignKey("MovieShop.Core.Entities.Favorite", "MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MovieShop.Core.Entities.Purchase", b =>
                {
                    b.HasOne("MovieShop.Core.Entities.Movie", "Movie")
                        .WithOne("Purchase")
                        .HasForeignKey("MovieShop.Core.Entities.Purchase", "MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
